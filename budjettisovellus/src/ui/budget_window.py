...
class BudgetView():
    ...
    def budget_view(self):
        ...
        editview_button = ttk.Button(
            master=self._frame, text="Edit and view", command=self._handle_purchases_list_view)
...
class PurchasesView():
    ...
    def purchases_view(self):
        ...
        add_purchase_button.grid(
            row=3, column=2, padx=5, pady=5, sticky=constants.EW)

        self._delete_purchase_label = ttk.Label(
            master=self._frame, text="Delete purchase: ")
        self._delete_purchase_label.grid(row=5, column=0, padx=5, pady=5)

        self._delete_purchase_entry = ttk.Entry(master=self._frame)
        self._delete_purchase_entry.grid(
        ...
        delete_purchase_button.grid(
            row=5, column=2, padx=5, pady=5, sticky=constants.EW)
